...
# Capitalize and append the new dictionary entries to lexicon_raw_nosil.txt, filtering out empty lines
grep -v '^$' $new_dict_file | tr '[:lower:]' '[:upper:]' >> $dst_dir/lexicon_raw_nosil.txt
